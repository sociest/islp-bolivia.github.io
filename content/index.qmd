...
## 🧭 ¿Cuál es tu Categoría? {#selector-categoria}
...
::: {.islp-cat-card .cat-bernoulli #bernoulli}
### 🌿 Categoría Bernoulli
...
::: {.islp-cat-card .cat-poisson #poisson}
### 📊 Categoría Poisson
...
## 🚀 La Ruta del Póster en 4 Pasos {#pasos}
...
{{< caso-estudio
  ...
  post_url="/posts/2022-06-15-caso-estudio-laplace-gotas-que-cuentan"
...
{{< caso-estudio
  ...
  post_url="/posts/2021-04-10-caso-estudio-bernoulli-redes-sociales"
...
{{< caso-estudio
  ...
  post_url="/posts/2021-04-12-caso-estudio-poisson-seguridad-alimentaria"
...
{{< caso-estudio
  ...
  post_url="/posts/2021-04-15-caso-estudio-gauss-contaminacion-aire"
...
## 🎁 Premios e Incentivos Oficiales {#premios}
...
[Descargar Cartilla de Premios PDF ↗](/posts/2026-08-10-cartilla-premios-incentivos){.islp-btn .islp-btn-sm .islp-btn-outline}
:::

::: {.islp-download-card}
#### 🌍 Fase Mundial (ISI / ISLP)
Los campeones nacionales de cada categoría representarán a Bolivia en el Congreso Mundial del **International Statistical Institute (ISI)**:

* **Categorías Bernoulli y Poisson:** 450 € (1.er lugar), 350 € (2.do lugar), 200 € (3.er lugar).
* **Categoría Gauss (Universitaria):** 2.000 € al ganador internacional + Mención de Honor JMP de SAS.

[Ver Detalles de la Fase Mundial ↗](https://iase-web.org/islp/){.islp-btn .islp-btn-sm .islp-btn-navy}
:::
...
## 📋 Reglas Fundamentales del Jurado {#reglas}
...
## 📅 Cronograma Oficial (5ª Versión 2026-2027) {#cronograma}

| Hito | Fechas | Estado |
| :--- | :--- | :--- |
| **Lanzamiento oficial de la 5ª Edición** | Octubre 2026 | 🟢 Publicado |
...
Primero, el tutor registra al equipo en el [Formulario en Línea ↗](https://docs.google.com/forms/d/e/1FAIpQLSc7rDxBwNfyn-kl7dL-n6cunoIeHJ2K8BwpLvJGb4jq_6uL0Q/viewform). Cuando el póster esté concluido, se envía en PDF a `islp.bolivia@gmail.com` con el asunto *"Póster CBPE 2027 – [Categoría] – [Nombre del Equipo]"* antes del 31 de marzo de 2027.
:::
...
## 🤝 Respaldos Institucionales y Coordinación {#coordinacion}
...
* **Coordinador Nacional:** M.Sc. Álvaro Chirino Gutiérrez (ISLP Bolivia / UMSA).
* **Comité Científico Evaluador:** Carrera de Estadística — Universidad Mayor de San Andrés (UMSA).
* **Investigación Cuantitativa Aplicada:** Fundación ARU.
* **Organismo Global:** International Association for Statistical Education (IASE) y el International Statistical Institute (ISI).

::: {.islp-cta-box}
### ¿Listo para investigar y contar tu historia con datos?
Postula tu equipo de forma gratuita y representa a Bolivia ante la comunidad estadística internacional.
